...
_STRINGS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "settings.tab.page_monitor": "ページモニター",
        "settings.tab.notifications": "通知",
        "settings.language_label": "言語 / Language:",
        "settings.startup_header": "自動起動",
        "settings.run_at_startup": "PC起動時に自動起動する",
        "settings.run_at_startup_hint": "Windows ログオン時にバックグラウンドで起動します",
        "settings.startup_failed_title": "自動起動の設定",
        "settings.startup_failed_message": "自動起動の設定変更に失敗しました。詳細はログを確認してください。",
        "settings.feature_a_header": "機能 A: 最新情報の取得",
        "settings.feature_b_header": "機能 B: 復習・クイズ",
        "settings.feature_c_header": "機能 C: ページモニター",
        "settings.feature_d_header": "機能 D: 前日ミーティング ダイジェスト",
        "settings.feature_a_schedule": "機能 A スケジュール",
        "settings.feature_b_schedule": "機能 B スケジュール",
        "settings.feature_c_schedule": "機能 C スケジュール",
        "settings.feature_d_schedule": "機能 D スケジュール",
        "settings.feature_c_enabled": "ページモニターを有効にする",
        "settings.feature_d_enabled": "前日ミーティング ダイジェストを有効にする",
        ...
        "settings.page_monitor_header": "監視対象ページ",
        "settings.page_url_label": "URL:",
        "settings.page_name_label": "名前:",
        "settings.page_mode_label": "モード:",
        "settings.page_add": "追加",
        "settings.page_remove": "削除",
        "settings.page_url_placeholder": "https://example.com",
        "settings.page_enabled": "有効",
        ...
        "notify.title_meetings": "📋 前日ミーティング ダイジェスト",
        "notify.body_meetings": "前営業日のミーティングを要約しました。クリックして確認してください。",
        "notify.open": "開く",
        ...
        "notify.processing_meetings_title": "⏳ ミーティングを要約中…",
        "notify.processing_meetings_body": "WorkIQ で前営業日のミーティングを取得・要約しています。完了までお待ちください。",
        "notify.error_label_news": "最新情報 (A)",
        "notify.error_label_quiz": "復習・クイズ (B)",
        "notify.error_label_monitor": "ページモニター (C)",
        "notify.error_label_meetings": "ミーティング ダイジェスト (D)",
        ...
        "tray.run_c_only": "ページモニター（C）のみ",
        "tray.run_d_only": "ミーティング ダイジェスト（D）のみ",
        "tray.run_all": "すべて（A → B → C → D）",
        ...
        "tray.feature_c": "ページモニター (C)",
        "tray.feature_d": "ミーティング ダイジェスト (D)",
    ...
    "en": {
        ...
        "settings.tab.page_monitor": "Page Monitor",
        "settings.tab.notifications": "Notifications",
        "settings.language_label": "言語 / Language:",
        "settings.startup_header": "Startup",
        "settings.run_at_startup": "Launch automatically at PC startup",
        "settings.run_at_startup_hint": "Starts in the background when you sign in to Windows",
        "settings.startup_failed_title": "Startup Setting",
        "settings.startup_failed_message": "Failed to change the startup setting. Please check the log for details.",
        "settings.feature_a_header": "Feature A: News Briefing",
        "settings.feature_b_header": "Feature B: Review & Quiz",
        "settings.feature_c_header": "Feature C: Page Monitor",
        "settings.feature_d_header": "Feature D: Daily Meeting Digest",
        "settings.feature_a_schedule": "Feature A Schedule",
        "settings.feature_b_schedule": "Feature B Schedule",
        "settings.feature_c_schedule": "Feature C Schedule",
        "settings.feature_d_schedule": "Feature D Schedule",
        "settings.feature_c_enabled": "Enable page monitor",
        "settings.feature_d_enabled": "Enable daily meeting digest",
        ...
        "settings.page_monitor_header": "Monitored Pages",
        "settings.page_url_label": "URL:",
        "settings.page_name_label": "Name:",
        "settings.page_mode_label": "Mode:",
        "settings.page_add": "Add",
        "settings.page_remove": "Remove",
        "settings.page_url_placeholder": "https://example.com",
        "settings.page_enabled": "Enabled",
        ...
        "notify.title_meetings": "📋 Daily Meeting Digest",
        "notify.body_meetings": "Your meetings from the previous business day have been summarized. Click to view.",
        "notify.open": "Open",
        ...
        "notify.processing_meetings_title": "⏳ Summarizing meetings...",
        "notify.processing_meetings_body": "Fetching and summarizing your meetings with WorkIQ. Please wait.",
        "notify.error_label_news": "News (A)",
        "notify.error_label_quiz": "Review & Quiz (B)",
        "notify.error_label_monitor": "Page Monitor (C)",
        "notify.error_label_meetings": "Meeting Digest (D)",
        ...
        "tray.run_c_only": "Page Monitor (C) Only",
        "tray.run_d_only": "Meeting Digest (D) Only",
        "tray.run_all": "All (A → B → C → D)",
        ...
        "tray.feature_c": "Page Monitor (C)",
        "tray.feature_d": "Meeting Digest (D)",
